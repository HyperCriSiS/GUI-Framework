...
- [ ] Spacey <!-- flat palette-neutral aerospace/instrumentation geometry, strong semantic frames, strict Basic-class performance budget, WCAG integration, Web/Chromium visual delta/compact validation and Compose Desktop/Android reference selection are complete; representative API 23/API 35 device-runtime validation remains -->
- [ ] Cyberpunk
