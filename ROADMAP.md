...
- [ ] Complete Compose semantics, input, focus and accessibility behavior. <!-- all five initial reference components are mapped and source-gated; broader runtime/integration validation remains -->
