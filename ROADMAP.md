...
- [ ] Radio <!-- neutral contract/tokens/Basic visuals, controlled Web adapter, Web/Compose group semantics, Web/Desktop/Android reference integration, cross-platform parity, WCAG target/contrast gates, Chromium compact/keyboard integration and Android runtime instrumentation are implemented; representative API 23/API 35 device-runtime confirmation remains -->
- [ ] Select / ComboBox
- [ ] Tabs
- [ ] Tooltip
- [ ] Menu / Context Menu
