...
- [ ] Modern <!-- inherited rounded geometry and neutral drop-shadow elevation are mapped in Web/Compose; shared palettes, explicit WCAG 2.2 AA integration checks, Chromium visual-delta baseline, compact validation and deterministic performance budget are CI-gated; Compose Modern selection and Android instrumentation are implemented; device-runtime confirmation remains -->
- [ ] Glass <!-- inherits Modern; crisp palette-neutral translucent Panel/Card and Dialog surfaces deliberately exclude blur/backdrop blur/glow; foundation/performance and alpha-composited WCAG gates plus Web visual-delta/compact validation and Compose selection/instrumentation are implemented; device-runtime confirmation remains -->
- [ ] Frosted Glass
- [ ] Spacey
- [ ] Cyberpunk
