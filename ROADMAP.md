...
- [ ] Cyberpunk <!-- extends Basic with 6 px semantic signal-frame geometry and bounded native Panel/Dialog elevation; structure/performance/WCAG gates, Web dark/light Chromium checks, compact validation, Compose Desktop/Android selection, parity and Android build are complete; representative API 23/API 35 device-runtime confirmation remains -->
