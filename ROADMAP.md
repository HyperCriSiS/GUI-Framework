...
- [ ] Basic <!-- all five reference components, declared sizes/states, shared functional interaction motion, reduced-motion handling, palette/contrast coverage and minimum-capability low-cost guards are gated; dense/compact layout and explicit performance verification remain -->
- [ ] Modern
- [ ] Glass
- [ ] Frosted Glass
- [ ] Spacey
