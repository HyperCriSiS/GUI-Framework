...
- [ ] Frosted Glass <!-- native Web 24 px backdropBlur is capability-resolved from neutral IR only for Panel/Card and Dialog; Chromium proves exact crisp-Glass fallback when unavailable; Compose Desktop/Android expose Frosted selection with deliberate no-emulation Glass fallback; dedicated performance and WCAG gates are green; representative API 23/API 35 runtime confirmation remains -->
- [ ] Spacey
- [ ] Cyberpunk
