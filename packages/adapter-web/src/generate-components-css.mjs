...
function statePartSelector(rootSelector, componentId, state, partId) {
  ...
  if (componentId === "navigation") {
    ...
    const interactiveSelector = state === "selected"
      ? `${itemSelector}:where([aria-current="page"])`
      : stateSelector(itemSelector, state);
    if (partId === "item") return interactiveSelector;
  ...
  if (componentId === "form-layout" && ["error", "disabled"].includes(state)) {
    const fieldSelector = `${partSelector(rootSelector, componentId, "field")}:where([data-gui-state~="${state}"])`;
    if (partId === "field") return fieldSelector;
    if (["label", "control", "description", "error"].includes(partId)) return `${fieldSelector} > .gui-form-layout__${kebabPart(partId)}`;
    return partSelector(stateSelector(rootSelector, state), componentId, partId);
  }
...
function emitFoundation(lines, themeIds) {
  ...
  lines.push(
    `${scope} .gui-button {`, "  appearance: none;", "  box-sizing: border-box;", "  display: inline-flex;", "  min-inline-size: 0;", "  max-inline-size: 100%;", "  align-items: center;", "  justify-content: center;", "  border-style: solid;", "  border-width: 0;", "  background: transparent;", "  color: inherit;", "  font-family: inherit;", "  cursor: pointer;", "  user-select: none;", "  text-decoration: none;", "  overflow-wrap: anywhere;", "  white-space: normal;", "  vertical-align: middle;", "}", "",
    ...
    `${scope} .gui-input {`, "  appearance: none;", "  box-sizing: border-box;", "  display: inline-block;", "  min-inline-size: 0;", "  max-inline-size: 100%;", "  border-style: solid;", "  border-width: 0;", "  background: transparent;", "  color: inherit;", "  font-family: inherit;", "  vertical-align: middle;", "  outline: none;", "}", "",
    `${scope} .gui-input::placeholder { opacity: 1; }`, `${scope} .gui-input:disabled { cursor: default; }`, "",
    `${scope} .gui-select {`, "  appearance: none;", "  box-sizing: border-box;", "  display: inline-block;", "  min-inline-size: 0;", "  max-inline-size: 100%;", "  border-style: solid;", "  border-width: 0;", "  background: transparent;", "  color: inherit;", "  font-family: inherit;", "  vertical-align: middle;", "  outline: none;", "}", "",
    ...
    `${scope} .gui-tabs { box-sizing: border-box; min-inline-size: 0; }`, `${scope} .gui-tabs__tab-list {`, "  box-sizing: border-box;", "  display: flex;", "  min-inline-size: 0;", "  align-items: stretch;", "  border-style: solid;", "  border-width: 0;", "}", "",
    `${scope} .gui-tabs__tab {`, "  appearance: none;", "  box-sizing: border-box;", "  display: inline-flex;", "  min-inline-size: 0;", "  max-inline-size: 100%;", "  flex-direction: column;", "  align-items: center;", "  justify-content: center;", "  border: 0;", "  background: transparent;", "  color: inherit;", "  font: inherit;", "  cursor: pointer;", "  user-select: none;", "  overflow-wrap: anywhere;", "  white-space: normal;", "  outline: none;", "}", "",
    ...
    `${scope} .gui-navigation { box-sizing: border-box; min-inline-size: 0; }`, `${scope} .gui-navigation__list {`, "  box-sizing: border-box;", "  display: flex;", "  min-inline-size: 0;", "  align-items: stretch;", "  border-style: solid;", "  border-width: 0;", "}", "",
    `${scope} .gui-navigation:where([data-gui-variant="horizontal"]) .gui-navigation__list { flex-direction: row; }`, `${scope} .gui-navigation:where([data-gui-variant="vertical"]) .gui-navigation__list { flex-direction: column; }`, "",
    `${scope} .gui-navigation__item {`, "  appearance: none;", "  box-sizing: border-box;", "  position: relative;", "  display: inline-flex;", "  min-inline-size: 0;", "  max-inline-size: 100%;", "  align-items: center;", "  justify-content: center;", "  border: 0;", "  background: transparent;", "  color: inherit;", "  font: inherit;", "  cursor: pointer;", "  user-select: none;", "  outline: none;", "}", "",
    ...
    `${scope} .gui-navigation__icon,`, `${scope} .gui-navigation__label,`, `${scope} .gui-navigation__indicator { pointer-events: none; }`, `${scope} .gui-navigation__label { min-inline-size: 0; overflow-wrap: anywhere; }`, `${scope} .gui-navigation__icon[hidden],`, `${scope} .gui-navigation__label[hidden] { display: none; }`, "",
    ...
    `${scope} .gui-form-layout { box-sizing: border-box; display: grid; inline-size: 100%; min-inline-size: 0; grid-template-columns: repeat(var(--gui-form-layout-columns, 1), minmax(0, 1fr)); }`,
    `${scope} .gui-form-layout__section { box-sizing: border-box; display: grid; grid-column: 1 / -1; min-inline-size: 0; grid-template-columns: repeat(var(--gui-form-layout-columns, 1), minmax(0, 1fr)); }`,
    `${scope} .gui-form-layout__field { box-sizing: border-box; display: grid; min-inline-size: 0; grid-template-columns: minmax(0, 1fr); }`,
    `${scope} .gui-form-layout__label,`, `${scope} .gui-form-layout__control,`, `${scope} .gui-form-layout__description,`, `${scope} .gui-form-layout__error,`, `${scope} .gui-form-layout__actions { box-sizing: border-box; min-inline-size: 0; }`, `${scope} .gui-form-layout__label,`, `${scope} .gui-form-layout__description,`, `${scope} .gui-form-layout__error { overflow-wrap: anywhere; }`,
    `${scope} .gui-form-layout__label[hidden],`, `${scope} .gui-form-layout__description[hidden],`, `${scope} .gui-form-layout__error[hidden] { display: none; }`,
    `${scope} .gui-form-layout__control > * { max-inline-size: 100%; }`,
    `${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__field { grid-template-columns: minmax(min-content, max-content) minmax(0, 1fr); align-items: start; }`,
    `${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__control,`, `${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__description,`, `${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__error { grid-column: 2; }`,
    `${scope} .gui-form-layout__actions { display: flex; flex-wrap: wrap; grid-column: 1 / -1; }`, "",
    "@media (max-width: 480px) {",
    `  ${scope} .gui-form-layout,`, `  ${scope} .gui-form-layout__section { grid-template-columns: minmax(0, 1fr); }`,
    `  ${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__field { grid-template-columns: minmax(0, 1fr); }`,
    `  ${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__control,`, `  ${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__description,`, `  ${scope} .gui-form-layout:where([data-gui-variant="inline"]) .gui-form-layout__error { grid-column: 1; }`,
    "}", "",
    `${scope} .gui-scroll-container { box-sizing: border-box; min-inline-size: 0; min-block-size: 0; outline: none; }`,
    `${scope} .gui-scroll-container__content { box-sizing: border-box; min-inline-size: 0; min-block-size: 0; }`,
    `${scope} .gui-scroll-container:where([data-gui-variant="vertical"]) { overflow-y: auto; overflow-x: hidden; }`,
    `${scope} .gui-scroll-container:where([data-gui-variant="horizontal"]) { overflow-x: auto; overflow-y: hidden; }`,
    `${scope} .gui-scroll-container:where([data-gui-variant="both"]) { overflow: auto; }`,
    `${scope} .gui-scroll-container:where([data-gui-variant="vertical"]) .gui-scroll-container__content { inline-size: 100%; }`,
    `${scope} .gui-scroll-container:where([data-gui-variant="horizontal"]) .gui-scroll-container__content,`,
    `${scope} .gui-scroll-container:where([data-gui-variant="both"]) .gui-scroll-container__content { inline-size: max-content; min-inline-size: 100%; }`, "",
    ...
    `${scope} .gui-menu__item:disabled { cursor: default; }`, `${scope} .gui-menu__label { min-inline-size: 0; overflow-wrap: anywhere; }`, `${scope} .gui-menu__shortcut { margin-inline-start: auto; white-space: nowrap; }`, `${scope} .gui-menu__shortcut[hidden] { display: none; }`, `${scope} .gui-menu__separator { box-sizing: border-box; inline-size: 100%; }`, "",
    ...
    `${scope} .gui-progress__visual,`, `${scope} .gui-progress__track,`, `${scope} .gui-progress__indicator { box-sizing: border-box; }`, `${scope} .gui-progress__label { min-inline-size: 0; overflow-wrap: anywhere; }`, `${scope} .gui-progress__label[hidden] { display: none; }`, "",
    ...
    `${scope} .gui-toast__action { min-inline-size: 0; max-inline-size: 100%; overflow-wrap: anywhere; white-space: normal; }`, `${scope} .gui-toast__action:focus { outline: none; }`, "",
...
function generate(ir) {
  ...
  lines.push("@media (prefers-reduced-motion: reduce) {", `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-button,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-checkbox,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-input,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-select,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-tabs,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-navigation,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-tree,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-form-layout,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-scroll-container,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-data-grid,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-data-grid__row,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-menu,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-toast,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-progress,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-slider,`, `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-switch {`, "    transition-duration: 0ms !important;", "    transition-delay: 0ms !important;", "  }", `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-progress__indicator {`, "    animation: none !important;", "  }", `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-progress:where([data-gui-variant="linear"]):where([data-gui-state~="indeterminate"]) .gui-progress__indicator {`, "    transform: translateX(75%);", "  }", `  :where(${availableThemeIds.map((id) => `[data-gui-theme="${id}"]`).join(", ")}) .gui-progress:where([data-gui-variant="circular"]):where([data-gui-state~="indeterminate"]) .gui-progress__indicator {`, "    transform: rotate(-90deg);", "  }", "}", "");
  return `${lines.join("\n")}\n`;
}
