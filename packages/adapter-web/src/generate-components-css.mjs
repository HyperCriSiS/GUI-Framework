...
function emitFoundation(lines, themeIds) {
  ...
  lines.push(
    ...
    `${scope} .gui-navigation { box-sizing: border-box; }`, `${scope} .gui-navigation__list {`, "  box-sizing: border-box;", "  display: flex;", "  align-items: stretch;", "  border-style: solid;", "  border-width: 0;", "}", "",
    ...
    `${scope} .gui-navigation__item {`, "  appearance: none;", "  box-sizing: border-box;", "  position: relative;", "  display: inline-flex;", "  align-items: center;", "  justify-content: center;", "  border: 0;", "  background: transparent;", "  color: inherit;", "  font: inherit;", "  cursor: pointer;", "  user-select: none;", "  outline: none;", "}", "",
    ...
    `${scope} .gui-form-layout__label,`, `${scope} .gui-form-layout__control,`, `${scope} .gui-form-layout__description,`, `${scope} .gui-form-layout__error,`, `${scope} .gui-form-layout__actions { box-sizing: border-box; min-inline-size: 0; }`,
