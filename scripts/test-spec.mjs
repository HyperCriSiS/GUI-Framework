...
try {
  ...
  const expectedContractComponentIds=["button","checkbox","dialog","input","panel","radio","select","switch","tabs"];
  const expectedReferenceVisualIds=["button","checkbox","dialog","input","panel","radio","select","switch","tabs"];
