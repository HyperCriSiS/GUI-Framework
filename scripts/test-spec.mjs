...
try {
  ...
  const expectedContractComponentIds=["button","checkbox","dialog","input","panel","radio","select","switch","tabs","tooltip"];
  const expectedReferenceVisualIds=["button","checkbox","dialog","input","panel","radio","select","switch","tabs","tooltip"];
