...
try {
  ...
  const expectedContractComponentIds=["button","checkbox","data-grid","dialog","form-layout","input","menu","navigation","panel","progress","radio","scroll-container","select","slider","switch","table","tabs","toast","tooltip","tree"];
  const expectedReferenceVisualIds = ["button", "checkbox", "data-grid", "dialog", "form-layout", "input", "menu", "navigation", "panel", "progress", "radio", "scroll-container", "select", "slider", "switch", "table", "tabs", "toast", "tooltip", "tree"];
