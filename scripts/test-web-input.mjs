...
try {
  ...
  assert.throws(
    () => createGuiInput(fakeDocument, { value: "", accessibilityLabel: "   " }),
    { name: "TypeError", message: "GUI input accessibilityLabel must be a non-empty string" },
  );
  assert.throws(
    () => createGuiInput(fakeDocument, { value: "", accessibilityLabel: 42 }),
    { name: "TypeError", message: "GUI input accessibilityLabel must be a non-empty string" },
  );
